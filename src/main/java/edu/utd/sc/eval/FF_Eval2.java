	...
	public static void main(String[] args) {
		try {
			...
			for (File problem : folder.listFiles()) {
				final File domain_parent = new File("/Users/sonnguyen/Desktop/SC/domain_parent.pddl");
				...
				ErrorManager errorManager_parent = factory.parse(domain_parent, problem);
...
//					}
				...
				sum += (end1 - start1);
//				System.out.println(end1 - start1 + "\t" + pb_parent.isSolvable());
			}
