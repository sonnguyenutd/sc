 ...
 * return true for a pair of objects regardless of the order they were passed to
 * the constructor.
 * 
 * @param <T> one object.
...
public class Pair<T> {
	...
	public boolean equals(Object obj) {
		...
		if (first.equals(other.first) && second.equals(other.second)) {
			...
			// Still need to check reversed order, as hashcodes may be equal for different
			// objects
